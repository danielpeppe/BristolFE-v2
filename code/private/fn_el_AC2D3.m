function [el_K, el_C, el_M, loc_nd, loc_df] = fn_el_AC2D3(nds, els, D, rho, rayleigh_coefs, varargin)
%SUMMARY
...
%	part of the filename, fn_el_AC2D3.m.
%INPUTS
...
%AUTHOR
%	Paul Wilcox (11-Jan-2024 22:01:20)
